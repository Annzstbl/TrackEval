...
class HSMOT_8ch(_BaseDataset):
    ...
    def get_default_dataset_config():
        ...
        default_config = {
            'GT_FOLDER': '/data/users/litianhao/data/HSMOT/test/mot',  # Location of GT data
            'IMG_FOLDER': '/data/users/litianhao/data/HSMOT/test/npy',  #图像目录
